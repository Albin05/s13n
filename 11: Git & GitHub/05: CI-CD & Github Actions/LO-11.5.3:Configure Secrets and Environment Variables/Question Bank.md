### **Q1.** Why should sensitive values like API keys NOT be hardcoded in source code or GitHub Actions YAML files?

A. They increase application size
B. They reduce execution speed
C. They can be exposed and become a security risk
D. GitHub does not support hardcoded values

**Correct Answer:** C

---

### **Q2.** Which of the following is the correct use case for a **GitHub Secret**?

A. `APP_ENV=development`
B. `FEATURE_ENABLED=true`
C. `DATABASE_PASSWORD`
D. `LOG_LEVEL=debug`
...
### **Q3.** What happens if a secret value is accidentally printed in GitHub Actions logs?

A. GitHub blocks the workflow
B. GitHub encrypts the repository
C. GitHub masks the value automatically
D. The workflow fails immediately

**Correct Answer:** C

---

### **Q4.** Explain the difference between **environment variables** and **secrets** in GitHub Actions, with one real-world example for each.

_Hint:_ Consider visibility, purpose, and security risk.

---

### **Q5.** Why does GitHub Actions require workflows to be **rerun manually** after adding or updating secrets?

_Hint:_ Think about workflow execution timing.

---

## **Q6. Implementation Task 1: Using Environment Variables in GitHub Actions**
...
## **Q7. Implementation Task 2: Using Secrets Securely in GitHub Actions**

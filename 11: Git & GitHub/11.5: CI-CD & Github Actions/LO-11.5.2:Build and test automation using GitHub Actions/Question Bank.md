### **Q1.** What is the main purpose of **workflow triggers** in GitHub Actions?

A. To define programming logic
B. To decide when automation should run
C. To store workflow logs
D. To configure repositories

**Correct Answer:** B

---

### **Q2.** Which part of a GitHub Actions workflow specifies the **commands to execute**?
...
### **Q3.** A workflow configured to run only on `main` will:

A. Run on all branches
B. Run on feature branches only
C. Ignore feature branch pushes and run only when code reaches `main`
D. Run only once
...
### **Q5.** Explain how **GitHub Actions integrates with Pull Requests** to prevent unstable code from being merged.
...
## **Q6. Implementation Task: Direct Push Trigger on Main Branch**
...
## **Q7. Implementation Task: Feature Branch → Pull Request → Main Branch Trigger**

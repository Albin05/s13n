# Document-level vs Sentence-level Tasks

## Learning Objectives

By the end of this lesson, you will be able to:
- Understand the key concepts of Document-level vs Sentence-level Tasks
- Apply these concepts to practical problems
- Explain the importance of this topic in machine learning

## Introduction

[Introduction to Document-level vs Sentence-level Tasks]

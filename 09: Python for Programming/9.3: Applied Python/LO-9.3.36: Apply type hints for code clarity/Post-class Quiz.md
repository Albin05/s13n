...
## Do type hints enforce types at runtime in Python?
...
## How do you specify a function returns nothing?
A) -> void
B) -> None
C) -> Empty
...
## How do you specify a dictionary mapping strings to integers?

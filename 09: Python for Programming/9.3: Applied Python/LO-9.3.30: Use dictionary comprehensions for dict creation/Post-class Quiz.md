...
## How do you create a dictionary from two lists using comprehension?
...
## Which comprehension filters dictionary items correctly?
...
## What's the result of this nested dictionary comprehension?
```python

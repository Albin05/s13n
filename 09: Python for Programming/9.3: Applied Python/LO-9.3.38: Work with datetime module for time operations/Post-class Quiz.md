...
## What's the difference between date.today() and datetime.now()?
A) No difference
...
## What class represents a duration between two dates?
A) duration
B) timedelta
C) timespan
...
## What does datetime.weekday() return for Monday?
A) 0
B) 1
C) "Monday"

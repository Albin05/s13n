...
## What does csv.reader() return when reading a CSV file?
...
## What is the purpose of newline='' when opening a CSV file for writing?
...
## What method is used to skip the header row when using csv.reader()?
A) reader.skip()
B) reader.next()
C) next(reader)
D) reader[1:]
...
## How does csv.DictReader differ from csv.reader?
...
## What type are all values when read from a CSV file?

### **Q1. Why is branching important in Git?**

A) To permanently delete old commits
B) To allow isolated development without affecting the `main` branch
C) To push code directly to production
...
### **Q2. Which command creates a new branch but does NOT switch to it?**
...
### **Q3. Which branch naming follows recommended conventions?**
